        ...
        <Container className="pb-3 pt-2">
          <Row className="py-sm-5 pb-5">
            <Col
              ...
              data-aos-delay="300"
            >
              <div className="signUPbox d-flex justify-content-between align-items-center flex-column">
                <div>
                  <h3 className=" ff_helvetica fs_36 clr_white mb-1 pb-4">
                    Solana Developer Update
                  </h3>
                  <p className=" ff_helvetica fs_17 clr_grayC4">
                    Sign up to the newsletter and learn about new resources, new
                    commits, new proposals, and more.
                  </p>
                </div>
                <div className="email_border rounded-pill d-flex w-100 justify-content-between align-items-center bg-black">
                  <input
                    type="email"
                    name="email"
                    id="email"
                    placeholder="Email"
                    className=" border-0 w-75 bg-black email_input "
                  />
                  <button className="signUp_button ff_roboto fs_14 text-dark text_upper_case rounded-pill bg_lightGreen">
                    Sign&nbsp;up
                  </button>
                </div>
              </div>
            ...
            >
              <div className="signUPbox">
                <h3 className=" ff_helvetica fs_35 clr_white mb-1 pb-4">
                  Even more resources
                </h3>
                <p className=" ff_helvetica fs_18 clr_grayC4 pb-5 mb-2">
                ...
                <div>
                  <Row className="align-items-center">
                    <Col
                      ...
                      data-aos-delay="300"
                    >
                      <button className="w-100 ff_roboto button_animation_upward channels_button fs_15 rounded-pill clr_white text_upper_case d-flex justify-content-center align-items-center gap-2">
                        YouTube{" "}
                        <span>
                          <svg
                            width="27"
                          ...
                          >
                            <g clipPath="url(#clip0_1479_1507)">
                              <path
                      ...
                      <button className="w-100 ff_roboto button_animation_upward channels_button fs_15 rounded-pill clr_white text_upper_case d-flex justify-content-center align-items-center gap-2">
                        ...
                        <span>
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_1479_1513)">
                              <path
                                fillRule="evenodd"
                                clipRule="evenodd"
